...
We will demonstrate that the total number of candidate predictors we suggest is no more than:
4+(N1-100)/100. 
N1 is the total number of rows with complete outcome `sdq` data = 1173. 
4+(1173-100)/100 =
14.73 ~ 15
...
We will demonstrate that the total number of candidate predictors we suggest is no more than:
4+(N2-100)/100. N2 is the number of the smaller group in the outcome `violence`. In this case N2 = 90. 4+(90-100)/100 =
3.9 ~ 4
...
The R-squared value indicates that the model accounts for 13 % of the variation in `sqrtsdq.` The adjusted R-squared is an index and it is is 0.11, and the model is based on 1173 observations, and has 23 df. 
