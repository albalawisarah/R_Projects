---
title: "Preventive Dental Care and Hospitalization Trends Among Children in The US"
subtitle: "2022 National Survey of Children’s Health (NSCH) Data"
...
We will utilize our model, `m_polr`, to predict the frequency of preventive dental visits for two hypothetical children:
- Child 1: 8 years old, 4 or more ER visits, and hospitalized.
- Child 2: 15 years old, 4 or more ER visits, and hospitalized.
...
The C statistic = 0.5 + (0.0705/2) = 0.53525
With a low AUC value, we can see that the model has a poor predictive performance. The Nagelkerke score of 0.002 further supports this conclusion regarding the model. 
...
The data set was pulled from the National Survey for Child Health year 2022.
Data Source: https://www.childhealthdata.org/learn-about-the-nsch/nsch-codebooks
